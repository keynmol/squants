...
```scala mdoc:silent:reset
import squants.{DoubleVector, SVector}
...
vectorDouble.map[Length](Kilometers(_))      // QuantityVector(1.2 km, 4.3 km, 2.3 km)
```
...
val string = money.toString  // returns full precision amount with currency code
val formatted = money.toFormattedString // returns currency symbol and amount rounded based on currency rules
```
...
val range3 = 5000.kW +- 1000.kW              // 4000.kW to 6000.kW
```
